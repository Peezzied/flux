...
export function Nav() {
    ...
    useEffect(()=>{
        if(changeStyle){
            animate("#logoImg", { width: '2rem', scale: 2.5 }, transition)
            animate("svg", { width: '1.7rem' }, transition)
            animate("#btnMenu", { width: '1.7rem' }, {duration: 0.01, type: "tween"})
            animate(scope.current, { backdropFilter: 'blur(20px)',  backgroundColor: 'rgba(2, 6, 23, 0.6)'}, { delay: 0.3, duration: 0.2, type: 'tween'})
        } else{
            animate("#logoImg", { width: '4em', scale: 1.7 }, transition)
            animate("svg", { width: '2rem' }, transition)
            animate("#btnMenu", { width: '2rem' }, {duration: 0.01, type: "tween"})
            animate(scope.current, { backdropFilter: 'blur(0px)', backgroundColor: 'rgba(2, 6, 23, 0)'}, { delay: 0.3, duration: 0.2, type: "tween"})
        }
    }, [changeStyle])
            ...
            <div className="container mx-auto flex items-center mr-auto p-5 lg:py-7 ">
                ...
                <div className="w-3/4 flex justify-center">
                    <Link to='/'>
                        ...
                        <img id="logoImg" className="w-16 scale-[1.7] h-auto chemphase" src={logo} alt="chemphase" srcset="" />
                    </Link>
                </div>
