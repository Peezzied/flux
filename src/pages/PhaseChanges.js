...
export default function PhaseChanges() {
    ...
    return(
        <>
            ...
            <DivBox container='max-w-full 2xl:container' div='bg-gradient-to-b from-white to-[#5A97BF] from-[27%] to-[200%] py-[5.7em]'>
                <div className="grid sm:px-7 xl:px-20  grid-rows-[auto_1fr] lg:grid-cols-2 gap-x-10 lg:gap-y-28">
                    <div className=" mx-3 col-span-3 lg:col-span-1 h-max">
                    ...
                    <div className="mx-3 sm:mx-0 grid justify-items-end items-end col-span-3 lg:col-span-1 mt-20">
                        <div className="grid grid-cols-[1fr_auto] border-subtle bg-[#ebf1f4] drop-shadow-sm sm:rounded-[35px] rounded-br-none rounded-3xl overflow-hidden sm:rounded-br-none h-max">
                    ...
                    <div className="sm:mx-3 mx-0 grid lg:grid-cols-4 grid-cols-2 grid-rows-[150px_150px_150px_150px_150px_150px_150px] lg:grid-rows-[150px_100px_150px_150px_150px_150px] gap-2 lg:col-span-2 col-span-3 mt-10 lg:mt-0">
            ...
            <DivBox container='max-w-6xl mx-auto' div='bg-gradient-to-b from-white to-[#5A97BF] from-[27%] to-[200%]'>
                <div className="space-y-14 sm:space-y-24 py-[6em] lg:py-[10em]   ">
                    <div className="sm:text-center relative max-w-max sm:mx-auto mx-3">
                    ...
                    <div className=" grid gap-10 sm:gap-5 ">
                        <div className="mx-3 grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-5 gap-y-1">
                            {diagram.cards.map((i, index) => (
                                <div className="rounded-2xl bg-[#EBF1F4] lg:p-10 lg:px-14 p-5 sm:p-7 px-7 sm:px-10 space-y-2 border-2 border-[#D5DFE3]">
                        ...
                        <div className="sm:mx-3 order-first sm:order-last sm:rounded-[18px] sm:border-2 border-y-2 border-[rgba(0,0,0,0.1)] border-subtle overflow-hidden"><img src={diagram.img} alt="" /></div>
                    </div>
